...
$_['entry_test_mode_info'] 	            = 'If you switch to Test Mode while in Live Mode, it will affect the receipt of logistic result notifications from ECPay for orders.';
$_['entry_type']                        = '類型';
...
$_['entry_TCAT_Collection_fee']         = '黑貓宅配取貨付款運費';
...
$_['error_TCAT_Collection_fee']         = '請輸入' . $_['entry_TCAT_Collection_fee'];
